...
如果用户想要更强的反 AI 味，先读取 `handdrawn-style-seeds.md` 选择具体手绘工具风格。默认用白底彩铅草稿风；需要更克制、更清爽、更像思考草稿时用铅笔草图风；需要诊断、批改或反风格清单时用红笔批改风。再套用本文件的主体和构图规则。若本机存在 `references/style-reference.local.md`，先读取它锁定默认风格参考。
